class Game {
  ...
  draw() {
    ...
    if (this.status == "PLAYING") {
      ...
      // Weapon
      this.ctx.fillText('Weapon: ', 195, 31);
      ...
      this.ctx.fillText((1.0 - this.world.currentPlayer.damageTaken)*100, 370, 66);
      ...
      this.ctx.fillText("Current player: P" + this.world.currentPlayer.playerNo, 1200, 70);
      ...
      this.ctx.fillText("Shooting force: " + ShootingPower.power + " / " + ShootingPower.max, 1200, 31);
