class GrenadeLevel2 extends Projectile{
    /**
     * Constructor for the grenade launcher level 2 that extends the Projectile class.
     */
    ...
    update(world, deltaT){
        ...
        if (world.map.collideWithRectangle(this)) {
            ...
            world.map.destroyCircle(this.center.x, this.center.y, 60); //3x radius than regular grenade
